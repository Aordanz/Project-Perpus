        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            if (searchInput) {
                searchInput.addEventListener('input', function() {
                    ...
                    if (clearSearchBtn) {
                        if (query === '') clearSearchBtn.classList.add('hidden');
                        else clearSearchBtn.classList.remove('hidden');
                    }
