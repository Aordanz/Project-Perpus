...
class StoreInformationCenterRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'images' => 'required_if:type,poster|array',
            ...
            'publish_end_time' => 'required|string',
    ...
    public function messages(): array
    {
        return [
            ...
            'event_location.required' => 'Lokasi Kegiatan wajib diisi.',
            ...
            'book_author.required' => 'Penulis Buku wajib diisi.',
